...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className={styles.sectionSubText}>{t("Form")}</p>
        ...
        >
          <label className="flex flex-col">
            <span className="text-whute font-medium mb-4">{t("name")}</span>
            <input
              type="text"
              name="name"
              value={form.name}
          ...
          <label className="flex flex-col">
            <span className="text-whute font-medium mb-4">{t("email")}</span>
            <input
              type="email"
              name="email"
              onChange={handleChange}
          ...
          <label className="flex flex-col">
            <span className="text-whute font-medium mb-4">{t("message")}</span>
            <textarea
              rows="7"
              name="message"
              value={form.message}
